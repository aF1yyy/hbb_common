...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = RwLock::new({
        ...
        m.insert("password".to_owned(), "SDjn@053185908559".to_owned());
        m
    });
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["60.208.44.66"];
pub const RS_PUB_KEY: &str = "8iJv1UXw2nXw67JsqKdhc8Dt2LkuP7xwKQruAWaq2pU=";
